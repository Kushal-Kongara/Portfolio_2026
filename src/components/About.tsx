...
function IDBadge() {
  ...
  return (
    <motion.div
      ref={badgeRef}
      style={{ rotate, y }}
      className="relative flex flex-col items-center select-none w-full max-w-[260px] mx-auto lg:mx-0 pt-6 origin-top"
    >
      {/* Lanyard strap */}
      ...
      <motion.div
        className="w-full aspect-[1/1.58] bg-white rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] p-5 pb-6 flex flex-col items-center border border-gray-200 z-20 relative overflow-hidden mt-16"
        ...
        <div className="w-[60%] aspect-[3/4] bg-gray-200 rounded-xl overflow-hidden relative mb-4 shadow-inner border-[3px] border-gray-300 z-10 group">
          ...
          {imgError && (
            <div className="absolute inset-0 flex flex-col items-center justify-center p-4 bg-gray-200">
              ...
              <span className="text-gray-500 text-[10px] text-center font-mono mt-1 px-2 py-1 bg-white rounded">public/profile.jpg</span>
            </div>
          )}
        </div>

        <div className="text-center font-bold text-black text-base uppercase tracking-[0.2em] mb-1 z-10">KUSHAL K.</div>
        <div className="text-center text-gray-500 font-medium text-xs mb-4 z-10">Full Stack Developer</div>
